...
insert into question(id, description, is_deleted, last_redaction_date, persist_date, title, user_id)
values (202, 'question2', false, now(), now(), 'question2', 112);
insert into question(id, description, is_deleted, last_redaction_date, persist_date, title, user_id)
values (203, 'question3', false, now(), now(), 'question3', 112);
...
values (401, 10, now(), 2, 301, 112, 201, 111);

insert into votes_on_answers(id, persist_date, vote, answer_id, user_id) values (501, now(), 'VoteAnswer', 301, 111)
