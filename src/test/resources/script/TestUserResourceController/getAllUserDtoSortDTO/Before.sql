...
VALUES (101, 'I am test user', 'Moscow', 'user101@mail.ru', 'User 101', '/images/noUserAvatar.png', false, true,
        DATE(NOW()),
        null, null, null, 'user_101', '$2a$12$9dF54oXy1UTGPmuuxc1LUOWnkeETVoFuomzL.ip3YA1BqdLqP3.se', DATE(NOW()), 102),

       (102, 'I am test user', 'Moscow', 'user102@mail.ru', 'User 102', '/images/noUserAvatar.png', false, true,
        DATE(NOW()),
        null, null, null, 'user_102', '$2a$12$9dF54oXy1UTGPmuuxc1LUOWnkeETVoFuomzL.ip3YA1BqdLqP3.se', DATE(NOW()), 101),

       (103, 'I am test user', 'Moscow', 'user103@mail.ru', 'User 103', '/images/noUserAvatar.png', false, true,
        DATE(NOW()),
        null, null, null, 'user_103', '$2a$12$9dF54oXy1UTGPmuuxc1LUOWnkeETVoFuomzL.ip3YA1BqdLqP3.se', DATE(NOW()), 101),

       (104, 'I am test user', 'Moscow', 'user104@mail.ru', 'User 104', '/images/noUserAvatar.png', false, true,
        DATE(NOW()),
        null, null, null, 'user_104', '$2a$12$9dF54oXy1UTGPmuuxc1LUOWnkeETVoFuomzL.ip3YA1BqdLqP3.se', DATE(NOW()), 101),

       (105, 'I am test user', 'Moscow', 'user105@mail.ru', 'User 105', '/images/noUserAvatar.png', false, true,
        DATE(NOW()),
        null, null, null, 'user_105', '$2a$12$9dF54oXy1UTGPmuuxc1LUOWnkeETVoFuomzL.ip3YA1BqdLqP3.se', DATE(NOW()), 101),

       (106, 'I am test user', 'Moscow', 'user106@mail.ru', 'User 106', '/images/noUserAvatar.png', false, true,
        DATE(NOW()),
        null, null, null, 'user_106', '$2a$12$9dF54oXy1UTGPmuuxc1LUOWnkeETVoFuomzL.ip3YA1BqdLqP3.se', DATE(NOW()), 102),

       (107, 'I am test user', 'Moscow', 'user107@mail.ru', 'User 107', '/images/noUserAvatar.png', false, true,
        DATE(NOW()),
        null, null, null, 'user_107', '$2a$12$9dF54oXy1UTGPmuuxc1LUOWnkeETVoFuomzL.ip3YA1BqdLqP3.se', DATE(NOW()), 102),

       (108, 'I am test user', 'Moscow', 'user108@mail.ru', 'User 108', '/images/noUserAvatar.png', false, true,
        DATE(NOW()),
        null, null, null, 'user_108', '$2a$12$9dF54oXy1UTGPmuuxc1LUOWnkeETVoFuomzL.ip3YA1BqdLqP3.se', DATE(NOW()), 102),

       (109, 'I am test user', 'Moscow', 'user109@mail.ru', 'User 109', '/images/noUserAvatar.png', false, true,
        DATE(NOW()),
        null, null, null, 'user_109', '$2a$12$9dF54oXy1UTGPmuuxc1LUOWnkeETVoFuomzL.ip3YA1BqdLqP3.se', DATE(NOW()), 102),

       (110, 'I am test user', 'Moscow', 'user110@mail.ru', 'User 110', '/images/noUserAvatar.png', false, true,
        DATE(NOW()),
        null, null, null, 'user_110', '$2a$12$9dF54oXy1UTGPmuuxc1LUOWnkeETVoFuomzL.ip3YA1BqdLqP3.se', DATE(NOW()), 102);
